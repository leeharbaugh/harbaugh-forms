...
* Published forms are protected from structural editing (PDF replace, mappings, form-field associations, automatic source configuration, shared structural metadata). Preference defaults (Personal / Organization) remain editable and never rewrite existing packet field instances.
