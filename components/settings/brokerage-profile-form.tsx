  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <FormSection
        ...
        description="Firm-level information used on forms and agreements (not the individual broker of record)."
      ...
      <FormSection
        title="Broker of Record / Person"
        description="Individual broker details for form population (not the firm)."
      >
        <div className="space-y-2">
