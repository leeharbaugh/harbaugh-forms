...
**As of:** 2026-09-05 (Signing snapshot boundary, lifecycle, participant identity, and working-document state responsibility settled; native e-signature architecture design continues; packet property-picker search + assignment-mode fixes remain live in production)
